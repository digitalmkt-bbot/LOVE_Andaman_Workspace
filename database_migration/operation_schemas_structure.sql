...
CREATE TABLE operation_schemas."sb_agents__contracthistory__programperiods" (
...
CREATE TABLE operation_schemas."sb_agents__contracthistory__addonservices" (
    "sb_agents_contracthistory_id" text,
    "idx" bigint,
    "row_pk" text,
    "svcid" text,
...
CREATE TABLE operation_schemas."sb_agents__contracthistory__addonservices__variants" (
...
CREATE TABLE operation_schemas."sb_agents__contracthistory__prices" (
    "sb_agents_contracthistory_id" text,
    "key" text,
    "row_pk" text,
    "pk_adult_thai" bigint,
