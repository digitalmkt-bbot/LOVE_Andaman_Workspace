-- operation_schemas structure · dumped from the LIVE DB 2026-07-09
-- (post 2026-07 mapper migration: date-keyed maps are key-value child tables, 52 FKs)
...
ALTER TABLE operation_schemas."boats__repairhistory" ADD CONSTRAINT "fk_boats_repairhistory" FOREIGN KEY ("boats_id") REFERENCES operation_schemas."boats" ("id");
ALTER TABLE operation_schemas."fleet_daily__trips" ADD CONSTRAINT "fleet_daily__trips_fleet_daily_id_fkey" FOREIGN KEY ("fleet_daily_id") REFERENCES operation_schemas."fleet_daily" ("id");
ALTER TABLE operation_schemas."fleet_engines__log" ADD CONSTRAINT "fk_fleet_engines_log" FOREIGN KEY ("fleet_engines_id") REFERENCES operation_schemas."fleet_engines" ("id");
ALTER TABLE operation_schemas."fleet_gearboxes__log" ADD CONSTRAINT "fk_fleet_gearboxes_log" FOREIGN KEY ("fleet_gearboxes_id") REFERENCES operation_schemas."fleet_gearboxes" ("id");
ALTER TABLE operation_schemas."fleet_incidents__damagedassets" ADD CONSTRAINT "fk_fleet_incidents_damagedassets" FOREIGN KEY ("fleet_incidents_id") REFERENCES operation_schemas."fleet_incidents" ("id");
ALTER TABLE operation_schemas."fleet_incidents__progresslog" ADD CONSTRAINT "fk_fleet_incidents_progresslog" FOREIGN KEY ("fleet_incidents_id") REFERENCES operation_schemas."fleet_incidents" ("id");
ALTER TABLE operation_schemas."fleet_incidents__relatedmaintids" ADD CONSTRAINT "fk_fleet_incidents_relatedmaintids" FOREIGN KEY ("fleet_incidents_id") REFERENCES operation_schemas."fleet_incidents" ("id");
ALTER TABLE operation_schemas."fleet_inventory__history" ADD CONSTRAINT "fk_fleet_inventory_history" FOREIGN KEY ("fleet_inventory_id") REFERENCES operation_schemas."fleet_inventory" ("id");
ALTER TABLE operation_schemas."fleet_inventory__stocks" ADD CONSTRAINT "fk_fleet_inventory_stocks" FOREIGN KEY ("fleet_inventory_id") REFERENCES operation_schemas."fleet_inventory" ("id");
ALTER TABLE operation_schemas."fleet_maintenance__assets" ADD CONSTRAINT "fk_fleet_maintenance_assets" FOREIGN KEY ("fleet_maintenance_id") REFERENCES operation_schemas."fleet_maintenance" ("id");
ALTER TABLE operation_schemas."fleet_maintenance__parts" ADD CONSTRAINT "fk_fleet_maintenance_parts" FOREIGN KEY ("fleet_maintenance_id") REFERENCES operation_schemas."fleet_maintenance" ("id");
ALTER TABLE operation_schemas."fleet_maintenance__progresslog" ADD CONSTRAINT "fk_fleet_maintenance_progresslog" FOREIGN KEY ("fleet_maintenance_id") REFERENCES operation_schemas."fleet_maintenance" ("id");
ALTER TABLE operation_schemas."fleet_memos__items" ADD CONSTRAINT "fk_fleet_memos_items" FOREIGN KEY ("fleet_memos_id") REFERENCES operation_schemas."fleet_memos" ("id");
ALTER TABLE operation_schemas."fleet_projects__log" ADD CONSTRAINT "fk_fleet_projects_log" FOREIGN KEY ("fleet_projects_id") REFERENCES operation_schemas."fleet_projects" ("id");
ALTER TABLE operation_schemas."fleet_projects__plan" ADD CONSTRAINT "fk_fleet_projects_plan" FOREIGN KEY ("fleet_projects_id") REFERENCES operation_schemas."fleet_projects" ("id");
ALTER TABLE operation_schemas."fleet_propellers__log" ADD CONSTRAINT "fk_fleet_propellers_log" FOREIGN KEY ("fleet_propellers_id") REFERENCES operation_schemas."fleet_propellers" ("id");
ALTER TABLE operation_schemas."fleet_safety__inspections" ADD CONSTRAINT "fk_fleet_safety_inspections" FOREIGN KEY ("fleet_safety_id") REFERENCES operation_schemas."fleet_safety" ("id");
ALTER TABLE operation_schemas."fleet_safety__log" ADD CONSTRAINT "fk_fleet_safety_log" FOREIGN KEY ("fleet_safety_id") REFERENCES operation_schemas."fleet_safety" ("id");
ALTER TABLE operation_schemas."routes__overrides" ADD CONSTRAINT "routes__overrides_routes_id_fkey" FOREIGN KEY ("routes_id") REFERENCES operation_schemas."routes" ("id");
ALTER TABLE operation_schemas."routes__seasons" ADD CONSTRAINT "fk_routes_seasons" FOREIGN KEY ("routes_id") REFERENCES operation_schemas."routes" ("id");
ALTER TABLE operation_schemas."routes__times" ADD CONSTRAINT "fk_routes_times" FOREIGN KEY ("routes_id") REFERENCES operation_schemas."routes" ("id");
ALTER TABLE operation_schemas."sb_agents__activity" ADD CONSTRAINT "fk_sb_agents_activity" FOREIGN KEY ("sb_agents_id") REFERENCES operation_schemas."sb_agents" ("id");
ALTER TABLE operation_schemas."sb_agents__contracthistory" ADD CONSTRAINT "fk_sb_agents_contracthistory" FOREIGN KEY ("sb_agents_id") REFERENCES operation_schemas."sb_agents" ("id");
ALTER TABLE operation_schemas."sb_agents__programperiods" ADD CONSTRAINT "fk_sb_agents_programperiods" FOREIGN KEY ("sb_agents_id") REFERENCES operation_schemas."sb_agents" ("id");
ALTER TABLE operation_schemas."sb_agents__programs" ADD CONSTRAINT "fk_sb_agents_programs" FOREIGN KEY ("sb_agents_id") REFERENCES operation_schemas."sb_agents" ("id");
ALTER TABLE operation_schemas."sb_bookings__addons" ADD CONSTRAINT "fk_sb_bookings_addons" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__adjustments" ADD CONSTRAINT "fk_sb_bookings_adjustments" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__feeitems" ADD CONSTRAINT "fk_sb_bookings_feeitems" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__history" ADD CONSTRAINT "fk_sb_bookings_history" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__over" ADD CONSTRAINT "fk_sb_bookings_over" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__partialcancels" ADD CONSTRAINT "fk_sb_bookings_partialcancels" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__passengers" ADD CONSTRAINT "fk_sb_bookings_passengers" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__trips" ADD CONSTRAINT "fk_sb_bookings_trips" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_bookings__upgrades" ADD CONSTRAINT "fk_sb_bookings_upgrades" FOREIGN KEY ("sb_bookings_id") REFERENCES operation_schemas."sb_bookings" ("id");
ALTER TABLE operation_schemas."sb_invoices__bookingids" ADD CONSTRAINT "fk_sb_invoices_bookingids" FOREIGN KEY ("sb_invoices_id") REFERENCES operation_schemas."sb_invoices" ("id");
ALTER TABLE operation_schemas."sb_invoices__lineitems" ADD CONSTRAINT "fk_sb_invoices_lineitems" FOREIGN KEY ("sb_invoices_id") REFERENCES operation_schemas."sb_invoices" ("id");
ALTER TABLE operation_schemas."sb_markets__subs" ADD CONSTRAINT "fk_sb_markets_subs" FOREIGN KEY ("sb_markets_id") REFERENCES operation_schemas."sb_markets" ("id");
ALTER TABLE operation_schemas."sb_pickup_time_profiles__times" ADD CONSTRAINT "fk_sb_pickup_time_profiles_times" FOREIGN KEY ("sb_pickup_time_profiles_id") REFERENCES operation_schemas."sb_pickup_time_profiles" ("id");
ALTER TABLE operation_schemas."sb_rate_types__addons" ADD CONSTRAINT "fk_sb_rate_types_addons" FOREIGN KEY ("sb_rate_types_id") REFERENCES operation_schemas."sb_rate_types" ("id");
ALTER TABLE operation_schemas."sb_rate_types__charterrates" ADD CONSTRAINT "fk_sb_rate_types_charterrates" FOREIGN KEY ("sb_rate_types_id") REFERENCES operation_schemas."sb_rate_types" ("id");
ALTER TABLE operation_schemas."sb_rate_types__routebundles" ADD CONSTRAINT "fk_sb_rate_types_routebundles" FOREIGN KEY ("sb_rate_types_id") REFERENCES operation_schemas."sb_rate_types" ("id");
ALTER TABLE operation_schemas."sb_rate_types__routes" ADD CONSTRAINT "fk_sb_rate_types_routes" FOREIGN KEY ("sb_rate_types_id") REFERENCES operation_schemas."sb_rate_types" ("id");
ALTER TABLE operation_schemas."sb_rate_types__routevalidity" ADD CONSTRAINT "fk_sb_rate_types_routevalidity" FOREIGN KEY ("sb_rate_types_id") REFERENCES operation_schemas."sb_rate_types" ("id");
ALTER TABLE operation_schemas."sb_rate_types__seatrates" ADD CONSTRAINT "fk_sb_rate_types_seatrates" FOREIGN KEY ("sb_rate_types_id") REFERENCES operation_schemas."sb_rate_types" ("id");
ALTER TABLE operation_schemas."sb_seat_locks__log" ADD CONSTRAINT "fk_sb_seat_locks_log" FOREIGN KEY ("sb_seat_locks_id") REFERENCES operation_schemas."sb_seat_locks" ("id");
ALTER TABLE operation_schemas."sb_vehicles__dayroute" ADD CONSTRAINT "sb_vehicles__dayroute_sb_vehicles_id_fkey" FOREIGN KEY ("sb_vehicles_id") REFERENCES operation_schemas."sb_vehicles" ("id");
ALTER TABLE operation_schemas."sb_vehicles__daystatus" ADD CONSTRAINT "sb_vehicles__daystatus_sb_vehicles_id_fkey" FOREIGN KEY ("sb_vehicles_id") REFERENCES operation_schemas."sb_vehicles" ("id");
ALTER TABLE operation_schemas."sb_vehicles__log" ADD CONSTRAINT "fk_sb_vehicles_log" FOREIGN KEY ("sb_vehicles_id") REFERENCES operation_schemas."sb_vehicles" ("id");
ALTER TABLE operation_schemas."sb_vehicles__statusranges" ADD CONSTRAINT "fk_sb_vehicles_statusranges" FOREIGN KEY ("sb_vehicles_id") REFERENCES operation_schemas."sb_vehicles" ("id");
