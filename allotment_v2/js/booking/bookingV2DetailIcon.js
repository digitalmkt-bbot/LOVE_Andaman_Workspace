function bookingV2DetailIcon(name, size){
  const s = size || 14;
  const ic = {
    ...
    foc: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><path d="M16 8l-4 4"/>'
  };
  return `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0">${ic[name]||''}</svg>`;
}
